...
data = pd.read_csv(
    r"C:\Users\ISHIKA\ml\loan-prediction-problem-dataset\train_u6lujuX_CVtuZ9i.csv"
)
testdata = pd.read_csv(
    r"C:\Users\ISHIKA\ml\loan-prediction-problem-dataset\test_Y3wMUE5_7gLdaTN.csv"
)
...
normalize = (df - df.mean()) / df.std()
testdata.drop(
    ["ApplicantIncome", "CoapplicantIncome", "LoanAmount"], axis=1, inplace=True
)
