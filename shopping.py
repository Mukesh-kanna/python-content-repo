...
def show_help():
    ...
    print(
        "Input DONE when done, SHOW to show present list , REMOVE to delete and item and HELP to get this message again"
    )
...
while True:
    ...
    if new_item == "DONE":
        ...
        index = input(
            "Press Enter to put items at end of list "
            "or give me a spot to put in.There are {} items in List".format(
                len(shopping)
            )
        )
